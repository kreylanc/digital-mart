...
const MobileNav = () => {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="ml-auto md:hidden text-primary"
      >
        <Menu />
      </button>
    );
  ...
  return (
    <div aria-label="mobile nav drawer">
      ...
      <div className="fixed overflow-y-scroll overscroll-y-none inset-0 z-40 flex">
        <div className="w-full">
          <div className="relative flex w-full max-w-sm ml-auto flex-col overflow-y-auto bg-white pb-12 shadow-xl">
